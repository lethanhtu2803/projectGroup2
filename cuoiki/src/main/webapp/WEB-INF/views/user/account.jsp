          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="fullName" id="inputUsername" type="text" placeholder="Nhập họ và tên" required>
                    </div>
                    <div class="mb-3">
                      <label class="small mb-1" for="inputPassword">Mật khẩu mới</label>
                      <input class="form-control" name="newPass" id="inputPassword"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%]).{8,}" type="password" placeholder="Nhập mật khẩu mới" required>
                  </div>
                  <div class="mb-3">
                    <label class="small mb-1" for="inputUsername">Xác nhận mật khẩu</label>
                    <input class="form-control" name="confirm" id="inputConfirmPassword" type="password" placeholder="Nhập lại mật khẩu của bạn" required>
                  </div>
                  <script>
                  ...
                  <div class="mb-3">
                    ...
                    <input class="form-control" name="address" id="inputAddress" type="text" placeholder="Nhập địa chỉ" required>
                </div>
                    <!-- Form Group (email address)-->
                    <div class="mb-3">
                        <label class="small mb-1" for="inputEmailAddress">Email</label>
                        <input class="form-control" name="email" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" id="inputEmailAddress" type="email" placeholder="Nhập email" required>
                    </div>
                    <!-- Form Row-->
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control" name="phoneNumber" id="inputPhone" pattern="(\(\+[0-9]{2}\)|0)([0-9]{9,10})" type="tel" placeholder="Nhập số điện thoại của bạn" required>
                        </div>
                        <!-- Form Group (birthday)-->
                        <div class="col-md-6">
